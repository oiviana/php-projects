...
<body>
    ...
    <div class="container" style="text-align: center;">
     <h2 style="font-size: 220%;">Deseja excluir a categoria "<?php  echo $resultado["nome"];?>"</h2>
     
     <div class="row">
      <form class="col s12" action="confirmaexclusao.php" method="POST">
        <div class="row">
          <div class="input-field col s6">
            <input readonly id="first_name" type="text" class="validate" name="nome"  value="<?php  echo $resultado["nome"];?>" required>
