...
include('dados_conexao.php');
	...
	try {
		...
		$consulta = $conecta->prepare("SELECT tb1_evento.*, (SELECT count(*) from tb3_visita WHERE tb3_codevento = tb1_codevento ) numerovisitas FROM tb1_evento WHERE tb1_codfuncionario = '$_SESSION[codfuncionario]' AND tb1_nomeevento = '$_REQUEST[dadosvisitas]' ORDER BY tb1_codevento  DESC LIMIT 1");
	...
	if ( count($resultadoDaConsulta) ) {
		foreach($resultadoDaConsulta as $registro) {
            ...
            $StringJson .= '"numerovisitas":"' . $registro['numerovisitas']    . '",';
