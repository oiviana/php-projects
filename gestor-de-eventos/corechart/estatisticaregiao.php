...
$sql8 = "";
         ...
         $sql2 = "SELECT tb1_evento.*, (SELECT count(*) from tb3_visita WHERE tb3_codevento = tb1_codevento and tb3_bairrovisita = 'Alvinopolis') segundaregiao FROM tb1_evento WHERE tb1_codfuncionario = '$_SESSION[codfuncionario]'   AND tb1_nomeevento = '$_REQUEST[buscagrafico]' ORDER BY tb1_codevento  DESC LIMIT 1";
         ...
         $sql7 = "SELECT tb1_evento.*, (SELECT count(*) from tb3_visita WHERE tb3_codevento = tb1_codevento and tb3_bairrovisita = 'Maracana') setimaregiao FROM tb1_evento WHERE tb1_codfuncionario = '$_SESSION[codfuncionario]'   AND tb1_nomeevento = '$_REQUEST[buscagrafico]' ORDER BY tb1_codevento  DESC LIMIT 1";
